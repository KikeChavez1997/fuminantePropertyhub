@extends('layouts.app', ['activePage' => 'dashboard', 'titlePage' => __('Pago-Invitado')])
...
@php
    ...
    // Crea un objeto de preferencia
      ...
      $item->title = session('inVservicio');
      $item->description = session('inVservicio');
      $item->currency = 'MXN';
      $item->quantity = 1;
      $item->unit_price = session('inVpago');

      $preference->back_urls = array(
      "success" => route('guest.order.success'),
      "failure" => route('guest.order.failure'),
      "pending" => route('guest.order.pending'),
      );
...
<div class="container" style="height: auto;"><br><br><br>
    <div class="justify-content-center">
          ...
          @if (session('inVtipoPago') == 'mercado_pago') 
              ...
              <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <p style="font-size:19px;">Tipo de servicio: {{session('inVservicio') }}</p>
                        ...
                        <p style="font-size:19px;">Superficie: {{session('inVsuperficie') }} m2</p>
                        <p style="font-size:19px;">Total a pagar: ${{ session('inVpago') }}</p>
          ...
          @elseif (session('inVtipoPago') == 'transferencia')
              ...
              <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <p>
                          Podras realizar el pago de ${{ session('inVpago') }} con el concepto de "Servicio fuminante" a la siguiente cuenta,
              ...
              <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <p>
                          Usted ha elegido realizar el pago de ${{session('inVpago')}} en el día del servicio.
