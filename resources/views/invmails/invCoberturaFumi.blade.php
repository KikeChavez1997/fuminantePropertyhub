               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#003ca6">Un cliente trato de reservar un servicio pero su codigo postal no esta dentro de la cobertura.</h1></td> 
                     </tr> 
                     <tr> 
                      <td style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;font-size:16px">
                        ...
                        Nombre: {{ $datos['inVnombre'] }}<br><br>
                        Apellido: {{ $datos['inVapellidos'] }}<br><br>
                        Telefono: {{ $datos['inVtelefono'] }}<br><br>
                        Correo electrónico: {{ $datos['inVcorreo_electronico'] }}<br><br>
                        Servicio: {{$datos['inVresidencial']}} <br> <br>
                        Tipo de servicio: {{$datos['inVservicio']}} <br> <br>
                        Codigo postal : {{$datos['inVcodigo_postal']}} <br> <br>
                        Superficie : {{$datos['inVsuperficie']}} m2 <br>
