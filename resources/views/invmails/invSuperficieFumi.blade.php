               ...
               <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:bold;color:#003ca6">Un cliente trato de realizar una reservación para su negocio pero supero los 100 m2</h1></td> 
                     </tr> 
                     <tr> 
                      <td style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;font-size:16px">
                        ...
                        Los datos del cliente son los siguientes:<br><br>
                        Nombre: {{ session('inVnombre') }}<br><br>
                        Apellido: {{ session('inVapellidos') }}<br><br>
                        Telefono: {{ session('inVtelefono') }}<br><br> 
                        Correo electrónico: {{ session('inVcorreo_electronico') }}<br><br>
                        Servicio: {{ session('inVresidencial') }} <br> <br>
                        Tipo de servicio: {{ session('inVservicio') }} <br> <br>
                        Codigo postal : {{ session('inVcodigo_postal') }} <br> <br>
                        Superficie : {{ session('inVsuperficie') }} m2 <br>
                        </p></td> 
                     </tr> 
                     <tr> 
