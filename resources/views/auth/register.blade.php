      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-info text-center">
            <h4 class="card-title"><strong>{{ __('Crea una cuenta') }}</strong></h4>
          ...
          <div class="card-body ">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('Acepto los ') }} <a class="card-link" href="https://fuminante.com/terminos-y-condiciones/">{{ __('Términos y Condiciones') }}</a>
              </label>
            </div>
          </div>
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-success btn-round">{{ __('Crear cuenta') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
