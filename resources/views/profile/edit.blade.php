@extends('layouts.app', ['activePage' => 'settings', 'titlePage' => __('')])
          ...
          <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title" style="font-size:24px; font-weight:bold;">{{ __('Editar perfil') }}</h4>
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title" style="font-size:24px; font-weight:bold;">{{ __('Cambiar contraseña') }}</h4>
              </div>
              <div class="card-body ">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-info">{{ __('Cambiar clave') }}</button>
              </div>
            </div>
          </form>
        </div>
